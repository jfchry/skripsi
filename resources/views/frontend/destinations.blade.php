        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb small mb-0 bg-transparent p-0">
                        ...
                        <li class="breadcrumb-item active text-white-50" aria-current="page">Destinations</li>
                    </ol>
                </nav>

                <p class="text-uppercase fw-bold text-success mb-2 tracking-wider small">
                    Smart Tourism Platform • Nature Wonders
                </p>
            ...
            <div class="col-lg-5 d-none d-lg-block">
                <div class="p-4 bg-success bg-opacity-10 rounded-4 border border-success border-opacity-10 shadow-sm" style="backdrop-filter: blur(4px);">
                    <h5 class="fw-bold text-success mb-2">🌿 Panduan Eksplorasi</h5>
                    <p class="small text-white mb-3">Untuk pengalaman petualangan terbaik dan aman di destinasi Bukit Lawang, perhatikan tips berikut:</p>
                    <div class="d-flex flex-column gap-2 small">
                        <div class="d-flex align-items-start gap-2 text-white">
                            <span>🥾</span>
                            <div><strong>Safety Gear:</strong> Gunakan sepatu/sandal gunung anti slip saat trekking ke hutan atau area sungai.</div>
                        </div>
                        <div class="d-flex align-items-start gap-2 text-white">
                            <span>🐒</span>
                            <div><strong>Eco-Rules:</strong> Jaga jarak aman dengan Orangutan, dilarang memberi makan satwa tanpa izin komite guide.</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container py-4">
        ...
        @forelse ($destinations as $index => $destination)
            <div class="row align-items-center g-5 mb-5 {{ $index % 2 != 0 ? 'flex-lg-row-reverse' : '' }}">
                ...
                <!-- Kolom Informasi dengan Tipografi yang Diperkuat -->
                <div class="col-lg-6 my-3 my-lg-0">
                    <div class="pe-lg-4 ps-lg-4">
                        ...
                        <h2 class="fw-bold text-dark mb-3 display-6 hover-target" style="letter-spacing: -0.5px;">
                            {{ $destination->name }}
                        </h2>

                        <!-- Garis Dekoratif Pendek -->
                        <div class="bg-success rounded" style="width: 50px; height: 4px; mb-4; margin-bottom: 1.5rem;"></div>

                        <!-- Deskripsi dengan Aligment yang Nyaman Dibaca -->
            ...
            <!-- Pembatas antar row esensial (Kecuali item terakhir) -->
            @if(!$loop->last)
...
<style>
    ...
    /* Efek Zoom-In Gambar saat Wrapper di-Hover */
